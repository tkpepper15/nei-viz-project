...
export const CircuitConfigurationTab: React.FC<BottomPanelTabProps> = ({
  ...
  return (
    <div className="flex flex-col bg-neutral-900 text-white">
      {/* Section tabs */}
      <div className="flex bg-neutral-800 border-b border-neutral-800">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
              activeSection === section.id
                ? 'border-primary text-neutral-200 bg-neutral-700'
            ...
            <div className="bg-neutral-800 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-mono text-neutral-200">{gridStats.totalConfigs.toLocaleString()}</div>
                  <div className="text-xs text-neutral-400">Total Configs</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-mono text-neutral-200">{gridStats.computedConfigs.toLocaleString()}</div>
                  <div className="text-xs text-neutral-400">Computed</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-mono text-neutral-200">{gridStats.completionPercentage.toFixed(1)}%</div>
                  <div className="text-xs text-neutral-400">Complete</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-mono text-neutral-200">{gridStats.gridSize}</div>
                        ...
                        <div key={key} className="flex justify-between items-center">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className={`font-mono text-xs px-2 py-1 rounded ${
                              Math.abs(difference) < 5 ? 'bg-neutral-700 text-neutral-200' :
