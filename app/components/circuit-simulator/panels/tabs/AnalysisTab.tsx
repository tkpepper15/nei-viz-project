              ...
              <div className="flex items-center gap-2">
                ...
                {pentagonAnalysis.isRunning ? (
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-primary hover:bg-primary-dark disabled:bg-neutral-600 text-white text-sm rounded transition-colors flex items-center gap-1"
                  >
            ...
            {pentagonAnalysis.groundTruth && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="bg-neutral-800 rounded p-3">
                  ...
                  />
                  <div className="text-xs text-neutral-400 mt-1">
                    <span className="text-neutral-400">■</span> Ground Truth
                    <span className="text-red-400 ml-4">■</span> Current
                    <span className="text-neutral-400 ml-4">■</span> Best Match
                  </div>
                </div>
              </div>
            )}
