...
export const TERTECAnalysisTab: React.FC<BottomPanelTabProps> = ({
  ...
  return (
    <div className="p-4 space-y-4">
      {/* Header and Controls */}
      <div className="bg-neutral-800 rounded-lg border border-neutral-800 p-4">
            ...
            <button
              ...
              className={`w-full px-4 py-2.5 rounded-lg font-medium transition-all ${
                visualizationApplied
                  ? 'bg-neutral-700 text-neutral-100'
                  : 'bg-neutral-700 hover:bg-neutral-600 text-neutral-200 disabled:bg-neutral-700 disabled:text-neutral-500'
              }`}
            >
              {visualizationApplied ? (
      ...
      {selectedGroup && (
        <div className="bg-neutral-800 rounded-lg border border-neutral-800 overflow-hidden">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {(['Rsh', 'Ra', 'Rb', 'Ca', 'Cb'] as const).map((param) => {
                  ...
                  return (
                    <tr key={param} className="border-b border-neutral-800 hover:bg-neutral-750">
                      ...
                      <td className="px-4 py-2 text-right text-neutral-200 font-mono font-medium">
      ...
      <div className="bg-neutral-800 rounded-lg border border-neutral-800 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-neutral-400">
          <div className="space-y-1">
            ...
            <p><strong className="text-neutral-300">IQR:</strong> Interquartile range (Q3 - Q1), indicates spread</p>
          </div>
          <div className="space-y-1">
            <p><strong className="text-neutral-300">CV:</strong> Coefficient of Variation = (IQR/2) / Median × 100%</p>
