    ...
    <div className="flex-1 overflow-y-auto min-h-0 bg-neutral-900">
      <div className="p-4 space-y-4">
          ...
          {exportFormat === 'csv' && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-primary hover:bg-primary-dark disabled:bg-neutral-600 disabled:cursor-not-allowed text-white rounded transition-colors flex items-center justify-center gap-2"
              >
                {isExporting ? (
                  <>
        ...
        <div className="bg-neutral-800/50 rounded p-3 border border-border">
          <h4 className="text-xs font-medium text-neutral-400 mb-2">Export Notes</h4>
