    ...
    <div className="w-full h-full bg-black text-white p-4">
      <div className="h-full flex flex-col">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-neutral-800/50 rounded border border-neutral-800">
            {/* Grid Points Control */}
        ...
        {pentagonAnalysis.groundTruth ? (
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 min-h-0">
            ...
            <div className="lg:col-span-2 bg-neutral-800/30 rounded border border-neutral-800">
            ...
            <div className="space-y-3">
              {/* Progress */}
              <div className="bg-neutral-800/30 rounded border border-neutral-800 p-3">
